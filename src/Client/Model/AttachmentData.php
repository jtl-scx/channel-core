...
class AttachmentData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      */
    protected static string $openAPIModelName = 'AttachmentData';
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (!preg_match("/^\\w+\\.\\w{1,10}$/", $this->container['filename'])) {
            $invalidProperties[] = "invalid value for 'filename', must be conform to the pattern /^\\w+\\.\\w{1,10}$/.";
        }
    ...
    public function setSellerId(string $sellerId): AttachmentData
    {
    ...
    public function setTicketId(string $ticketId): AttachmentData
    {
    ...
    public function setFilename(string $filename): AttachmentData
    {

...
class Stock implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setSellerId(string $sellerId): Stock
    {
    ...
    public function setOfferId(int $offerId): Stock
    {
    ...
    public function setChannelOfferId(string $channelOfferId): Stock
    {
    ...
    public function setUpdatedAt(\DateTime $updatedAt): Stock
    {

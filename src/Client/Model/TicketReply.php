 ...
 */
class TicketReply implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TicketReply';
    ...
    public function setSellerId(string $sellerId): TicketReply
    {
    ...
    public function setTicketId(string $ticketId): TicketReply
    {
    ...
    public function setReplyRequested(?bool $replyRequested): TicketReply
    {
    ...
    public function setCreatedAt(\DateTime $createdAt): TicketReply
    {
    ...
    public function setFrom(TicketFrom $from): TicketReply
    {
    ...
    public function setMessage(string $message): TicketReply
    {
    ...
    public function setAttachment(?array $attachment): TicketReply
    {

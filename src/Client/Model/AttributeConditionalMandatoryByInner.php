<?php
/**
 * AttributeConditionalMandatoryByInner
 *
 * PHP version 8.4
 *
 * @category Class
...
/**
 * AttributeConditionalMandatoryByInner Class Doc Comment
 *
 * @category Class
 * @package  JTL\SCX\Lib\Channel\Client
 * @author   OpenAPI Generator team
 ...
 */
class AttributeConditionalMandatoryByInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      */
    protected static string $openAPIModelName = 'Attribute_conditionalMandatoryBy_inner';
    ...
    public function setAttributeId(?string $attributeId): AttributeConditionalMandatoryByInner
    {
    ...
    public function setAttributeValues(?array $attributeValues): AttributeConditionalMandatoryByInner
    {

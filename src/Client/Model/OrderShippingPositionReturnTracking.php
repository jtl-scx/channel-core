<?php
/**
 * OrderShippingPositionReturnTracking
 *
 * PHP version 8.4
 *
 * @category Class
...
/**
 * OrderShippingPositionReturnTracking Class Doc Comment
 *
 * @category Class
 ...
 */
class OrderShippingPositionReturnTracking implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      */
    protected static string $openAPIModelName = 'OrderShippingPosition_returnTracking';
    ...
    public function setCarrier(string $carrier): OrderShippingPositionReturnTracking
    {
    ...
    public function setTrackingNumber(string $trackingNumber): OrderShippingPositionReturnTracking
    {

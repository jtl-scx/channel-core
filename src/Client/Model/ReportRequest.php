...
class ReportRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setSellerId(string $sellerId): ReportRequest
    {
    ...
    public function setReportType(ReportType $reportType): ReportRequest
    {
    ...
    public function setStartDate(?\DateTime $startDate): ReportRequest
    {
    ...
    public function setEndDate(?\DateTime $endDate): ReportRequest
    {

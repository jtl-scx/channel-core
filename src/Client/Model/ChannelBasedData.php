...
class ChannelBasedData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setGroup(?string $group): ChannelBasedData
    {
    ...
    public function setPricing(?string $pricing): ChannelBasedData
    {
    ...
    public function setChannelType(?string $channelType): ChannelBasedData
    {
    ...
    public function setLogo(?string $logo): ChannelBasedData
    {

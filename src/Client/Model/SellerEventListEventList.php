...
class SellerEventListEventList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function getEvent(): 
    {
        return $this->container['event'];
    }

    public function setEvent( $event): SellerEventListEventList
    {

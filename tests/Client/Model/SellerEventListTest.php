 ...
 * @link        https://openapi-generator.tech
 */
#[CoversClass(\JTL\SCX\Lib\Channel\Client\Model\SellerEventList::class)]
class SellerEventListTest extends AbstractApiModelTestCase
{
    /**
     * @return array
     */
    public static function expectedInterface(): array
    {
        return [
            'assert property eventList' => [
                'eventList',
                '\JTL\SCX\Lib\Channel\Client\Model\SellerEventListEventListInner[]',
                'getEventList',
                'setEventList',
                true
            ],
    ...
    public function it_has_expected_interface(string $property, string $type, string $expectedGetter, string $expectedSetter, bool $isNullable): void
    {
        ...
        if ($isNullable) {
            $sut = new SellerEventList([$property => null]);

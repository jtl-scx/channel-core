 ...
 * @link        https://openapi-generator.tech
 */
#[CoversClass(\JTL\SCX\Lib\Channel\Client\Model\ChannelStatus::class)]
class ChannelStatusTest extends AbstractApiModelTestCase
{
    /**
     * @return array
     */
    public static function expectedInterface(): array
    {
        return [
            ...
            'assert property channel' => [
                'channel',
                '\JTL\SCX\Lib\Channel\Client\Model\SalesChannel',
                'getChannel',
                'setChannel',
                true
            ],

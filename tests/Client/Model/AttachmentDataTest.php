 ...
 * @link        https://openapi-generator.tech
 */
#[CoversClass(\JTL\SCX\Lib\Channel\Client\Model\AttachmentData::class)]
class AttachmentDataTest extends AbstractApiModelTestCase
{
    /**
     * @return array
     */
    ...
    public function it_has_expected_interface(string $property, string $type, string $expectedGetter, string $expectedSetter, bool $isNullable): void
    {
        ...
        $sut = new AttachmentData([$property => $sample]);
        ...
        if ($isNullable) {
            $sut = new AttachmentData([$property => null]);

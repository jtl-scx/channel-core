...
/**
 * OrderConfirmTest Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://openapi-generator.tech
 */
#[CoversClass(\JTL\SCX\Lib\Channel\Client\Model\OrderConfirm::class)]
class OrderConfirmTest extends AbstractApiModelTestCase
{
    /**
     * @return array
     */
    ...
    public function it_has_expected_interface(string $property, string $type, string $expectedGetter, string $expectedSetter, bool $isNullable): void
    {
        ...
        $sut = new OrderConfirm([$property => $sample]);
        ...
        if ($isNullable) {
            $sut = new OrderConfirm([$property => null]);

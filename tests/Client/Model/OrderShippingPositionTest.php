 ...
 * @link        https://openapi-generator.tech
 */
#[CoversClass(\JTL\SCX\Lib\Channel\Client\Model\OrderShippingPosition::class)]
class OrderShippingPositionTest extends AbstractApiModelTestCase
{
    /**
     * @return array
     */
    public static function expectedInterface(): array
    {
        return [
            ...
            'assert property returnTracking' => [
                'returnTracking',
                '\JTL\SCX\Lib\Channel\Client\Model\OrderShippingPositionReturnTracking',
                'getReturnTracking',
                'setReturnTracking',
                true
            ],
            ...
            'assert property orderItemIdList' => [
                'orderItemIdList',
                '\JTL\SCX\Lib\Channel\Client\Model\OrderShippingPositionItem[]',
                'getOrderItemIdList',
                'setOrderItemIdList',
                true
            ],
            'assert property shippedFrom' => [
                'shippedFrom',
                '\JTL\SCX\Lib\Channel\Client\Model\OrderShippingPositionShippedFrom',
                'getShippedFrom',
                'setShippedFrom',
                true
            ],
    ...
    public function it_has_expected_interface(string $property, string $type, string $expectedGetter, string $expectedSetter, bool $isNullable): void
    {
        ...
        if ($isNullable) {
            $sut = new OrderShippingPosition([$property => null]);

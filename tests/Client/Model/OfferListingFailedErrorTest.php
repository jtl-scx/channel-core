 ...
 * @link        https://openapi-generator.tech
 */
#[CoversClass(\JTL\SCX\Lib\Channel\Client\Model\OfferListingFailedError::class)]
class OfferListingFailedErrorTest extends AbstractApiModelTestCase
{
    /**
     * @return array
     */
    public static function expectedInterface(): array
    {
        return [
            ...
            'assert property relatedAttributeId' => [
                'relatedAttributeId',
                'string',
            ...
            'assert property recommendedValue' => [
                'recommendedValue',
                'string',
                'getRecommendedValue',
                'setRecommendedValue',

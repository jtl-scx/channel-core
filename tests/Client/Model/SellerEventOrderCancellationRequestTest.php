 ...
 * @link        https://openapi-generator.tech
 */
#[CoversClass(\JTL\SCX\Lib\Channel\Client\Model\SellerEventOrderCancellationRequest::class)]
class SellerEventOrderCancellationRequestTest extends AbstractApiModelTestCase
{
    /**
     * @return array
     */
    public static function expectedInterface(): array
    {
        return [
            ...
            'assert property orderItem' => [
                'orderItem',
                '\JTL\SCX\Lib\Channel\Client\Model\OrderCancellationItem[]',
                'getOrderItem',
                'setOrderItem',
                false
            ],
    ...
    public function it_has_expected_interface(string $property, string $type, string $expectedGetter, string $expectedSetter, bool $isNullable): void
    {
        ...
        if ($isNullable) {
            $sut = new SellerEventOrderCancellationRequest([$property => null]);

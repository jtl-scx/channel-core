 ...
 * @link        https://openapi-generator.tech
 */
#[CoversClass(\JTL\SCX\Lib\Channel\Client\Model\ChannelBasedData::class)]
class ChannelBasedDataTest extends AbstractApiModelTestCase
{
    /**
    ...
    public function it_has_expected_interface(string $property, string $type, string $expectedGetter, string $expectedSetter, bool $isNullable): void
    {
        ...
        if ($isNullable) {
            $sut = new ChannelBasedData([$property => null]);

...
/**
 * AdditionalOrderDataGroupTest Class Doc Comment
 *
 * @category    Class
 ...
 * @author      OpenAPI Generator team
 * @link        https://openapi-generator.tech
 * @covers      \JTL\SCX\Lib\Channel\Client\Model\AdditionalOrderDataGroup
 */
class AdditionalOrderDataGroupTest extends AbstractApiModelTest
{
    /**
     * @return array
     * @dataProvider
    ...
    public function expectedInterface(): array
    {
        return [
            ...
            'assert property Values' => [
                'values',
                '\JTL\SCX\Lib\Channel\Client\Model\AdditionalOrderDataGroupValues[]',
                'getValues',
                'setValues',
                true
            ],
    ...
    public function it_has_expected_interface(string $property, string $type, string $expectedGetter, string $expectedSetter, bool $isNullable): void
    {
        ...
        $sut = new AdditionalOrderDataGroup([$property => $sample]);
        ...
        if ($isNullable) {
            $sut = new AdditionalOrderDataGroup([$property => null]);

 ...
 * @link        https://openapi-generator.tech
 */
#[CoversClass(\JTL\SCX\Lib\Channel\Client\Model\OrderStatus::class)]
class OrderStatusTest extends AbstractApiModelTestCase
{
    /**
     * @return array
     */
    public static function expectedInterface(): array
    {
        return [
            ...
            'assert property orderItems' => [
                'orderItems',
                '\JTL\SCX\Lib\Channel\Client\Model\OrderStatusOrderItemsInner[]',
                'getOrderItems',
                'setOrderItems',
                true
            ],
